var questionAnswer = [
  ...
  {
    question: "  Q5. What is an element that does not have a closing tag called?",
  ...
  },
  {
    ...
    option: ["In the same folder", "Where ever is fine", "In different folders", "none of them"],
  },
  {
    question: " Q9. What is always a welcome page, and explains the purpose or topic of the site?",
    answer: "Homepage",
  ...
  },
  {
    ...
    option: ["Nothing", "Brings up a note pad with the HTML code already used for the site.", "Opens a new website.", "none of them"],
  },
];
